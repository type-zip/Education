...
namespace AsyncAwaitPlayground
{
    class Program
    {
        ...
        static void SimpleExample()
        {
            ...
            Task<string> stringWithValue = CreateStringWithValueAsync();
            ...
            // is completed.
            Console.WriteLine(stringWithValue.Result);
        }
        ...
        /// </summary>
        static async Task<string> CreateStringWithValueAsync()
        {
            /*
            ...
            // method, implicitly setting the value of the task captured in SomeExample()'s stringWithValue variable
            return resultString;
        }
